...
Object.freeze(V);
var nr = v4_default();
var Qa = class extends import_events.default {
  constructor() {
    super(...arguments);
  ...
  if (r.startsWith("rgb")) {
    ...
    if (o) {
      ...
      if (b === "  " || b === "  /" || b === ",," || b === ",,,") {
        ...
        if (j) {
          const R = [_e(+s / j, 0, 1), _e(+c / j, 0, 1), _e(+f2 / j, 0, 1), v ? Dr(+v, w) : 1];
          if (qr(R)) return R;
        }
      }
      return;
  ...
  static interpolate(e, t, n, a = "rgb") {
    switch (a) {
      ...
      case "hcl": {
        ...
        if (!isNaN(o) && !isNaN(u)) {
          let T = u - o;
          u > o && T > 180 ? T -= 360 : u < o && o - u > 180 && (T += 360), f2 = o + n * T;
        } else isNaN(o) ? isNaN(u) ? f2 = NaN : (f2 = u, (s === 1 || s === 0) && (d = c)) : (f2 = o, (p === 1 || p === 0) && (d = i));
        const [y, v, w, b] = vi([f2, d ?? ve(i, c, n), ve(s, p, n), ve(l, m, n)]);
...
var cr = class _cr {
  ...
  static parse(e, t) {
    ...
    for (let u = 2; u < e.length - 1; u += 2) {
      ...
      const f2 = t.parse(p, u, a);
      if (!f2) return null;
      a = a || f2.type, i.push(f2);
    }
...
var se = class _se {
  ...
  static parse(e, t) {
    ...
    for (let u = 0; u < i.length; u += 2) {
      const c = i[u], p = i[u + 1], m = u + 3, f2 = u + 4;
...
var vr = class {
  ...
  pointOnLine(e, t) {
    ...
    for (let l = 0; l < e.length - 1; l++) {
      let u = e[l][0], c = e[l][1], p = this.wrap(e[l + 1][0] - u) * this.kx, m = (e[l + 1][1] - c) * this.ky, f2 = 0;
      (p !== 0 || m !== 0) && (f2 = (this.wrap(t[0] - u) * this.kx * p + (t[1] - c) * this.ky * m) / (p * p + m * m), f2 > 1 ? (u = e[l + 1][0], c = e[l + 1][1]) : f2 > 0 && (u += p / this.kx * f2, c += m / this.ky * f2)), p = this.wrap(t[0] - u) * this.kx, m = (t[1] - c) * this.ky;
      const d = p * p + m * m;
      d < n && (n = d, a = u, o = c, i = l, s = f2);
    }
    return {
      point: [a, o],
      index: i,
...
function ps(r, e, t, n) {
  ...
  for (let o = e[0]; o < e[1]; ++o) {
    ...
    for (const l of t) for (let u = 0, c = l.length, p = c - 1; u < c; p = u++) {
      const m = l[p], f2 = l[u];
      if (It(i, s, m, f2)) return 0;
      a = Math.min(a, wr(i, s, m, f2, n));
    }
  }
  return a;
}
...
function fs(r, e, t, n = 1 / 0) {
  ...
  for (const s of r) for (let l = 0, u = s.length, c = u - 1; l < u; c = l++) {
    const p = s[c], m = s[l];
    for (const f2 of e) for (let d = 0, y = f2.length, v = y - 1; d < y; v = d++) {
      const w = f2[v], b = f2[d];
...
function dt(r, e, t, n, a, o = 1 / 0) {
  ...
  for (; s.length > 0; ) {
    ...
    if (pt(u) <= p && pt(c) <= m) {
      ...
      let f2;
      if (e && n) f2 = ls(r, u, t, c, a), i = Math.min(i, f2);
      else if (e && !n) {
        const d = r.slice(u[0], u[1] + 1);
        for (let y = c[0]; y <= c[1]; ++y) if (f2 = ke(t[y], d, a), i = Math.min(i, f2), i === 0) return i;
      } else if (!e && n) {
        const d = t.slice(c[0], c[1] + 1);
        for (let y = u[0]; y <= u[1]; ++y) if (f2 = ke(r[y], d, a), i = Math.min(i, f2), i === 0) return i;
      } else f2 = us(r, u, t, c, a), i = Math.min(i, f2);
    } else {
      const f2 = Xt(u, e), d = Xt(c, n);
      at2(s, i, a, r, t, f2[0], d[0]), at2(s, i, a, r, t, f2[0], d[1]), at2(s, i, a, r, t, f2[1], d[0]), at2(s, i, a, r, t, f2[1], d[1]);
    }
  }
  return i;
}
  ...
  static parse(e, t) {
    ...
    for (const [u, c] of s) {
      ...
      for (let f2 = 1; f2 < e.length; f2++) {
        const d = e[f2], y = Array.isArray(u) ? u[f2 - 1] : u.type, v = l.parse(d, 1 + p.length, y);
        if (!v) {
          m = true;
          break;
        }
      ...
      if (!m) {
        ...
        for (let f2 = 0; f2 < p.length; f2++) {
          const d = Array.isArray(u) ? u[f2] : u.type, y = p[f2];
          l.concat(f2 + 1).checkSubtype(d, y.type);
        }
    ...
    if (s.length === 1) t.errors.push(...l.errors);
      ...
      for (let m = 1; m < e.length; m++) {
        const f2 = t.parse(e[m], 1 + p.length);
        if (!f2) return null;
        p.push(N(f2.type));
      }
...
function Ls(r) {
  ...
  for (const f2 in n) !c && p.includes(f2) ? s.push(new h(f2, n[f2], `In "${t}": "${f2}" is only valid when "encoding" is set to "custom". ${m} encoding found`)) : o[f2] ? s = s.concat(r.validateSpec({
    key: f2,
    value: n[f2],
    valueSpec: o[f2],
    validateSpec: r.validateSpec,
    style: i,
    styleSpec: a
  })) : s.push(new h(f2, n[f2], `unknown property "${f2}"`));
  return s;
}
var an = {
  promoteId: Cs
...
H = /* @__PURE__ */ new WeakMap(), Q = /* @__PURE__ */ new WeakMap(), me = /* @__PURE__ */ new WeakMap(), he = /* @__PURE__ */ new WeakMap(), K = /* @__PURE__ */ new WeakMap(), Ye = /* @__PURE__ */ new WeakMap(), B = /* @__PURE__ */ new WeakSet(), ia = function(e) {
  ...
  const {
    ...
    o();
    const l = s === "parent" ? E(this, Q) : this.map, u = s === "parent" ? this.map : E(this, Q), c = l.getCenter(), p = l.getZoom() + E(this, H).zoomAdjust * (s === "parent" ? 1 : -1), m = l.getBearing(), f2 = l.getPitch();
    u.jumpTo({
      center: c,
      zoom: p,
      bearing: m,
  ...
  constructor(t) {
    ...
    const f2 = (d) => {
      d.terrain && (p = true, m = {
        ...
        target: this,
        terrain: d.terrain
      }, this.off("terrain", f2), c && this.fire("loadWithTerrain", m));
    };
    this.on("terrain", f2), t.terrain && this.enableTerrain(t.terrainExaggeration ?? this.terrainExaggeration), this.once("load", () => {
...
function ca(r, e) {
  ...
  for (const c of Array.from(u)) {
    ...
    const p = U(c, "Pair"), m = {};
    for (const f2 of Array.from(p)) m[_(k(f2, "key")) ?? ""] = _(k(f2, "styleUrl"));
    i[`#${Te(c, "id")}`] = m;
  }
...
function Hs(r, e, t, n) {
  ...
  let f2, d = _(k(r, "styleUrl")), y = k(r, "LineStyle"), v = k(r, "PolyStyle");
  ...
  if (p) {
    ...
    for (f2 = 0; f2 < b.length; f2++) o[b[f2].getAttribute("name") ?? ""] = _(k(b[f2], "value")) ?? "";
    for (f2 = 0; f2 < T.length; f2++) o[T[f2].getAttribute("name") ?? ""] = _(T[f2]) ?? "";
  }
...
var x = class _x extends Array {
  ...
  getCanvasStrip(t = {
    ...
    for (let m = 0; m < s; m += 1) {
      const f2 = this.getColor(l + m * p, {
        smooth: t.smooth
      });
      i[m * 4] = f2[0], i[m * 4 + 1] = f2[1], i[m * 4 + 2] = f2[2], i[m * 4 + 3] = f2.length > 3 ? f2[3] : 255;
    }
  ...
  resample(t, n = 15) {
    ...
    if (t === "ease-in-square") s = Array.from({
      ...
      const m = p * i, f2 = m ** 2, d = o.getColor(f2);
      return {
        value: m,
        color: d
      };
      ...
      const m = p * i, f2 = 1 - (1 - m) ** 2, d = o.getColor(f2);
      return {
        value: m,
        color: d
      };
      ...
      const m = p * i, f2 = m ** 0.5, d = o.getColor(f2);
      return {
        value: m,
        color: d
      };
      ...
      const m = p * i, f2 = 1 - (1 - m) ** 0.5, d = o.getColor(f2);
      return {
        value: m,
        color: d
      };
      ...
      const m = p * i, f2 = 1 - 2 ** (-10 * m), d = o.getColor(f2);
      return {
        value: m,
        color: d
      };
      ...
      const m = p * i, f2 = 2 ** (10 * m - 10), d = o.getColor(f2);
      return {
        value: m,
        color: d
      };
...
function il(r, e) {
  ...
  const p = e.outlineWidth ?? 1, m = e.outlineColor ?? "#FFFFFF", f2 = e.outlineOpacity ?? 1, d = e.outlineBlur ?? 0;
  if (typeof c == "string" && (c = ga(c)), e.outline === true) {
    ...
    a.polylineOutlineLayerId = y, r.addLayer({
      ...
      paint: {
        "line-opacity": typeof f2 == "number" ? f2 : P(f2),
...
function sl(r, e) {
  ...
  const i = e.outlineWidth ?? 1, s = e.outlineColor ?? "#FFFFFF", l = e.outlineOpacity ?? 1, u = e.outlineBlur ?? 0, c = e.fillColor ?? Ir(), p = e.fillOpacity ?? 1, m = e.outlinePosition ?? "center", f2 = e.pattern ?? null;
  ...
  if (a) {
    ...
    r.addLayer({
      ...
      paint: __spreadValues({
        ...
        "circle-stroke-opacity": typeof f2 == "number" ? f2 : P(f2),
...
function ul(r, e) {
  ...
  let f2 = 1;
  p ? typeof m == "number" ? (f2 = m, typeof e.weight == "number" && console.warn("The option `.property` is ignored when `.propertyValueWeights` is not of type `PropertyValueWeights`")) : Array.isArray(m) ? f2 = rl(m, p) : console.warn("The option `.property` is ignored when `.propertyValueWeights` is not of type `PropertyValueWeights`") : typeof m == "number" ? f2 = m : Array.isArray(m) && console.warn("The options `.propertyValueWeights` can only be used when `.property` is provided.");
  const d = [{
    zoom: 0,
    value: 50 * 0.025
  }, {
