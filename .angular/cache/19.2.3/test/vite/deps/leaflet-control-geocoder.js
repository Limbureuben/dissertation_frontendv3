  ...
  geocode(t) {
    return __async(this, null, function* () {
      const n = u(this.options, {
        ...
        maxLocations: 10,
        f: "json"
      }), e = yield d(this.options.serviceUrl + "/findAddressCandidates", n), o = [];
      if (e.candidates && e.candidates.length) for (let i = 0; i <= e.candidates.length - 1; i++) {
        const r = e.candidates[i], l = s.latLng(r.location.y, r.location.x), c = s.latLngBounds(s.latLng(r.extent.ymax, r.extent.xmax), s.latLng(r.extent.ymin, r.extent.xmin));
        o[i] = {
          name: r.address,
          bbox: c,
          center: l
  ...
  reverse(t, n) {
    return __async(this, null, function* () {
      const e = h(this.options, {
        ...
        distance: 100,
        f: "json"
      }), o = yield d(this.options.serviceUrl + "/reverseGeocode", e), i = [];
      if (o && !o.error) {
...
var y = class {
  ...
  geocode(t) {
    return __async(this, null, function* () {
      ...
      }), e = yield d(this.options.serviceUrl, n), o = [];
  ...
  reverse(t, n) {
    return __async(this, null, function* () {
      const e = h(this.options, {
        key: this.options.apiKey
      }), o = yield d(this.options.serviceUrl + t.lat + "," + t.lng, e), i = [];
...
var x = class {
  ...
  geocode(t) {
    return __async(this, null, function* () {
      ...
      }, e = this.options.serviceUrl + "/address/json", o = yield d(e, n), i = [];
  ...
  reverse(t, n) {
    return __async(this, null, function* () {
      const e = {
        ...
        query: t.lat + "," + t.lng,
        "subscription-key": this.options.apiKey
      }, o = this.options.serviceUrl + "/address/reverse/json", i = yield d(o, e), r = [];
  ...
  geocode(t) {
    return __async(this, null, function* () {
      ...
      if (e.results && e.results.length) for (let i = 0; i <= e.results.length - 1; i++) {
        const r = e.results[i], l = s.latLng(r.geometry.location), c = s.latLngBounds(s.latLng(r.geometry.viewport.northeast), s.latLng(r.geometry.viewport.southwest));
        o[i] = {
  ...
  reverse(t, n) {
    return __async(this, null, function* () {
      const e = h(this.options, {
        key: this.options.apiKey,
        latlng: t.lat + "," + t.lng
      }), o = yield d(this.options.serviceUrl, e), i = [];
      if (o.results && o.results.length) for (let r = 0; r <= o.results.length - 1; r++) {
        const l = o.results[r], c = s.latLng(l.geometry.location), g = s.latLngBounds(s.latLng(l.geometry.viewport.northeast), s.latLng(l.geometry.viewport.southwest));
        i[r] = {
...
var U = class {
  ...
  getJSON(t, n) {
    return __async(this, null, function* () {
      const e = yield d(t, n), o = [];
      if (e.response.view && e.response.view.length) for (let i = 0; i <= e.response.view[0].result.length - 1; i++) {
        const r = e.response.view[0].result[i].location, l = s.latLng(r.displayPosition.latitude, r.displayPosition.longitude), c = s.latLngBounds(s.latLng(r.mapView.topLeft.latitude, r.mapView.topLeft.longitude), s.latLng(r.mapView.bottomRight.latitude, r.mapView.bottomRight.longitude));
        o[i] = {
  ...
  geocode(t) {
    return __async(this, null, function* () {
      const n = u(this.options, {
        ...
        limit: 5,
        outFormat: "json"
      }), e = yield d(this.options.serviceUrl + "/address", n);
  ...
  reverse(t, n) {
    return __async(this, null, function* () {
      const e = h(this.options, {
        ...
        outputFormat: "json"
      }), o = yield d(this.options.serviceUrl + "/reverse", e);
      return this._parseResults(o);
    });
  }
  _parseResults(t) {
...
var B = class {
  ...
  geocode(t) {
    return __async(this, null, function* () {
      ...
      }), e = yield d(this.options.serviceUrl + "geocode-address", n), o = [];
      if (e.locations) {
  ...
  reverse(t, n) {
    return __async(this, null, function* () {
      const e = h(this.options, {
        ...
        latitude: t.lat,
        longitude: t.lng
      }), o = yield d(this.options.serviceUrl + "geocode-reverse", e), i = [];
  ...
  geocode(t) {
    return __async(this, null, function* () {
      const n = u(this.options, {
        ...
        format: "json",
        addressdetails: 1
      }), e = yield d(this.options.serviceUrl + "search", n), o = [];
  ...
  reverse(t, n) {
    return __async(this, null, function* () {
      const e = h(this.options, {
        ...
        addressdetails: 1,
        format: "json"
      }), o = yield d(this.options.serviceUrl + "reverse", e), i = [];
      if (o && o.lat && o.lon) {
  ...
  geocode(t) {
    return __async(this, null, function* () {
      const n = u(this.options, {
        key: this.options.apiKey,
        q: t
      }), e = yield d(this.options.serviceUrl, n);
      return this._parseResults(e);
    });
  }
  suggest(t) {
  ...
  reverse(t, n) {
    return __async(this, null, function* () {
      const e = h(this.options, {
        key: this.options.apiKey,
        q: [t.lat, t.lng].join(",")
      }), o = yield d(this.options.serviceUrl, e);
      return this._parseResults(o);
    });
  }
  _parseResults(t) {
  ...
  geocode(t) {
    return __async(this, null, function* () {
      const n = u(this.options, {
        ...
        text: t
      }), e = yield d(this.options.serviceUrl + "/search", n);
  ...
  suggest(t) {
    return __async(this, null, function* () {
      const n = u(this.options, {
        api_key: this.options.apiKey,
        text: t
      }), e = yield d(this.options.serviceUrl + "/autocomplete", n);
      return this._parseResults(e, "bbox");
    });
  }
  reverse(t, n) {
  ...
  reverse(t, n) {
    return __async(this, null, function* () {
      const e = h(this.options, {
        lat: t.lat,
        lon: t.lng
      }), o = yield d(this.options.reverseUrl, e);
      return this._parseResults(o);
    });
  }
  _parseResults(t) {
...
var T = class {
  ...
  geocode(t) {
    return __async(this, null, function* () {
      const n = yield d(this.options.serviceUrl + "forward", u(this.options, {
        key: this.options.apiKey,
        //get three words and make a dot based string
        addr: t.split(/\s+/).join(".")
      })), e = [];
  ...
  reverse(t, n) {
    return __async(this, null, function* () {
      const e = yield d(this.options.serviceUrl + "reverse", h(this.options, {
        key: this.options.apiKey,
...
var b = class extends _ {
  ...
  onAdd(n) {
    ...
    }) : this.options.expand === "touch" ? s.DomEvent.addListener(o, s.Browser.touch ? "touchstart mousedown" : "mousedown", (g) => {
  ...
  _geocode(n = false) {
    return __async(this, null, function* () {
      ...
      const r = n ? yield this.options.geocoder.suggest(e) : yield this.options.geocoder.geocode(e);
